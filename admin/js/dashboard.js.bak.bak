...
async function loadApartments() {
  const response = await fetch("/admin/php/apartments.php", {
    credentials: "include",
    cache: "no-store",
  });
...
async function loadMessages() {
  const response = await fetch("/admin/php/messages.php", {
    credentials: "include",
    cache: "no-store",
  });
...
async function createApartment(data, opts) {
  ...
  if (useMultipart) {
    ...
    console.log("🚀 Sending to /admin/php/apartment_create.php");
    res = await fetch("/admin/php/apartment_create.php", {
      method: "POST",
      credentials: "include",
      body: fd,
    });
  } else {
    console.log("🚀 Sending JSON to /admin/php/apartment_create.php");
    res = await fetch("/admin/php/apartment_create.php", {
      method: "POST",
      credentials: "include",
...
async function updateApartment(id, data, opts) {
  ...
  if (useMultipart) {
    ...
    res = await fetch("/admin/php/apartment_update.php", {
      method: "POST",
      credentials: "include",
      body: fd,
    });
...
async function deleteApartment(id) {
  const res = await fetch("/admin/php/apartment_delete.php", {
    method: "POST",
    credentials: "include",
    headers: { "content-type": "application/json" },
